...
/** Planning workflow steps for Demand & Supply (keys drive ?step= URLs). */
export const DEMAND_SUPPLY_WORKFLOW_STEPS = [
  { key: "plan", label: "Monthly Target Plan", optional: false },
  { key: "targets", label: "Target Creation", optional: false },
  { key: "models", label: "Model Allocation", optional: false },
  { key: "articles", label: "Article Allocation", optional: true },
  { key: "review", label: "Review", optional: false },
  { key: "submit", label: "Submit", optional: false },
];
...
export const SEED_USERS = [
  ...
  { email: "itadmin@autoplan.com", password: "password123", role: ROLES.IT_ADMIN, name: "IT Administrator" },
];
